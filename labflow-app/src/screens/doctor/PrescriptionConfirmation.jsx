...
const MEDICATIONS = [
  { name: 'Artemether-Lumefantrine 80/480mg', detail: 'Tablet • Oral • BID for 3 days', qty: 6 },
  { name: 'Folic Acid 5mg',                   detail: 'Tablet • Oral • Once daily',      qty: 7 },
]
          ...
          <div style={{
            ...
            {MEDICATIONS.map((med, i) => (
              <div key={i} style={{
                ...
                marginBottom: i < MEDICATIONS.length - 1 ? '8px' : '0',
              }}>
                <div>
                  <p style={{ fontSize: '14px', fontWeight: '600', color: '#1a2b2b', margin: '0 0 3px' }}>{med.name}</p>
                  <p style={{ fontSize: '12px', color: '#5a7272', margin: 0 }}>{med.detail}</p>
                </div>
                <span style={{
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', marginTop: '14px', paddingTop: '14px', borderTop: '1px solid #e8f2f2' }}>
              <div>
                ...
                <p style={{ fontSize: '13px', fontWeight: '700', color: '#1a2b2b', margin: 0 }}>#RX-{patient.id.replace('PT-', '')}-MJ</p>
              </div>
              <div>
                <p style={{ fontSize: '10px', fontWeight: '700', color: '#8fa8a8', textTransform: 'uppercase', letterSpacing: '0.07em', margin: '0 0 4px' }}>FULFILLMENT</p>
                <p style={{ fontSize: '13px', fontWeight: '600', color: '#1a2b2b', margin: 0 }}>Estimated 2 Hours</p>
              </div>
            </div>
          </div>
